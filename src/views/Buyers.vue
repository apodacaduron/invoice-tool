...
<template>
  <div class="max-w-[1295px] mx-auto px-4 lg:px-6 py-4">
    ...
    <div v-if="buyersQuery.isLoading.value" class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      <div
        v-for="n in 6"
        :key="n"
    ...
    <div v-else class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        <div class="flex justify-between items-start">
          <div>
            <p class="buyer-info text-gray-600 dark:text-gray-400 text-sm whitespace-pre-line">
